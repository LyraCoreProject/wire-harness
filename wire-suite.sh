...
ALL_TESTS=(
  ...
  aoi_relay soak playerbots pet_control exploration rest_state group party_brains bot_goals class_roles bot_serendipity bot_follow bot_deadmines eventai_cast relay_stress
)
START=$(date +%s)
